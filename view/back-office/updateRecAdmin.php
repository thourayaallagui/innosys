...
$id = $_GET['id'];
$reclamation = $ReclamationC->findone($id); // You need this function in your controller

if ($_SERVER["REQUEST_METHOD"] == "POST") {
  $newStatut = $_POST['statut'];
  $ReclamationC->updateStatut($id, $newStatut); // Also implement this function
  header("Location: reclamtions.php"); // Adjust as needed
  exit();
}
?>
    ...
    <div class="main-panel">
      ...
      <div class="container">
        <div class="page-inner">
          <div class="row">
            <br>
            <h1 class="mt-5">Modifier le Statut de la Réclamation</h1>
            <br><br>
