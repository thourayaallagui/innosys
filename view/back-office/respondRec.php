...
if (!isset($_GET['id'])) {
  die("ID réclamation manquant.");
}

$id = $_GET['id'];
$reclamation = $ReclamationC->findone($id); // Again, this must exist
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (!empty($message)) {
    $reponse = new Reponse($date_reponse, $message, $_GET['id']);
    $ReponseC->create($reponse);
    $ReclamationC->updateStatut($_GET['id'], 'Résolue');
    exit();
  } else {
    ...
    <div class="main-panel">
      ...
      <div class="container">
        <div class="page-inner">
          <div class="row">
            <br>
            <h1 class="mt-5">Répondre à la Réclamation</h1>
            <br><br>
            <div class="container mt-5">
              ...
              <form method="POST" onsubmit="return validateForm();">
                <div class="mb-3">
                  ...
                  <div class="invalid-feedback">Veuillez entrer une réponse.</div>
                </div>

                <button type="submit" class="btn btn-success">Envoyer</button>
                <a href="reclamtions.php" class="btn btn-secondary">Annuler</a>
              </form>
            </div>
