    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="offres.php"  class="active">Offers</a></li>
  ...
  ?>
    <div class="col-md-6 col-lg-3" data-aos="zoom-out" data-aos-delay="<?= $delay ?>">
      <div class="icon-box p-4 border rounded h-100">
        ...
        <h4 class="title mb-2">
          <a href="#"><?= htmlspecialchars($offre['titre']) ?></a>
        </h4>
        <p class="description mb-3">
          <?= htmlspecialchars($offre['description']) ?>
        </p>

        <!-- Enriched data with English labels -->
        <ul class="list-unstyled small text-start mb-0">
          <li><strong>Discount:</strong> <?= (int)$offre['montant_reduction'] ?>%</li>
          <li><strong>From:</strong> <?= date('d/m/Y', strtotime($offre['date_debut'])) ?></li>
          <li><strong>To:</strong> <?= date('d/m/Y', strtotime($offre['date_fin'])) ?></li>
        </ul>
      </div>
    </div><!-- End Icon Box -->
  <?php endforeach; ?>
