...
$sponsor = $sponsorC->showSponsor($id);
?>
    ...
    <nav class="navbar navbar-main navbar-expand-lg mx-5 px-0 shadow-none rounded" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-2">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bold mb-0">      Liste des Sponsors  
          </h6>
          <ul class="list-group">
							<li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
								<div class="d-flex flex-column">
									<h6 class="mb-3 text-sm"> <?= $sponsor["id"]; ?> </h6>
									<span class="mb-2 text-xs">ID du sponsor : <span
											class="text-dark font-weight-bold ms-sm-2"> <?= $sponsor["id"]; ?>
										</span></span>
									<span class="mb-2 text-xs">Nom   : <span
											class="text-dark ms-sm-2 font-weight-bold">
											<?= $sponsor["nom"]; ?></span></span>
									<span class="mb-2 text-xs">Montant   : <span
											class="text-dark ms-sm-2 font-weight-bold">
											<?= $sponsor["mont"]; ?></span></span>
									<span class="mb-2 text-xs">Type: <span
											class="text-dark font-weight-bold ms-sm-2"> <?= $sponsor["type"]; ?>
										</span></span>
									<span class="mb-2 text-xs">Date  Acceptation  : <span
											class="text-dark ms-sm-2 font-weight-bold">
											<?= $sponsor["dateA"]; ?></span></span>
									<span class="mb-2 text-xs">Engagement : <span
											class="text-dark ms-sm-2 font-weight-bold">
											<?= $sponsor["engag"]; ?></span></span>
